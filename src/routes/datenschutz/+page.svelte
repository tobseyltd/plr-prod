...
<datenschutz-wrapper>
	...
	<p>
		...
		Endger&auml;t des Nutzers (z.&nbsp;B. f&uuml;r Device-Fingerprinting) im Sinne des TTDSG
	...
	<p>
		Christian Seyboth (Freelancer)<br />
		Allendeweg 12<br />
		12559 Berlin
	</p>
	...
	<p>
		...
		E-Mail: kontakt@programmieren-lernen.rocks
	</p>
	<p>
	...
	<p>
		...
		Zahlungsdaten (z.&nbsp;B. Kontonummer bei Einzugserm&auml;chtigung) zu &uuml;bermitteln, werden
		diese Daten zur Zahlungsabwicklung ben&ouml;tigt.
	</p>
	<p>
		Der Zahlungsverkehr &uuml;ber die g&auml;ngigen Zahlungsmittel (Visa/MasterCard,
		Lastschriftverfahren) erfolgt ausschlie&szlig;lich &uuml;ber eine verschl&uuml;sselte SSL- bzw.
		TLS-Verbindung. Eine verschl&uuml;sselte Verbindung erkennen Sie daran, dass die Adresszeile des
		Browsers von &bdquo;http://&ldquo; auf &bdquo;https://&ldquo; wechselt und an dem Schloss-Symbol
		in Ihrer Browserzeile.
	</p>
	<p>
		Bei verschl&uuml;sselter Kommunikation k&ouml;nnen Ihre Zahlungsdaten, die Sie an uns
		&uuml;bermitteln, nicht von Dritten mitgelesen werden.
	</p>
	...
	<p>
		Statt einer direkten Registrierung auf dieser Website k&ouml;nnen Sie sich mit Google
		registrieren. Anbieter dieses Dienstes ist die Google Ireland Limited (&bdquo;Google&rdquo;),
		Gordon House, Barrow Street, Dublin 4, Irland.
	</p>
	<p>
		Um sich mit Google zu registrieren, m&uuml;ssen Sie ausschlie&szlig;lich Ihre Google-Namen und
		Ihr Passwort eingeben. Google wird Sie identifizieren und unserer Website Ihre Identit&auml;t
		best&auml;tigen.
	</p>
	<p>
		Wenn Sie sich mit Google anmelden, ist es uns ggf. m&ouml;glich bestimmte Informationen auf
		Ihrem Konto zu nutzen, um Ihr Profil bei uns zu vervollst&auml;ndigen. Ob und welche
		Informationen das sind, entscheiden Sie im Rahmen Ihrer Google-Sicherheitseinstellungen, die Sie
		hier finden: <a
			href="https://myaccount.google.com/security"
			target="_blank"
			rel="noopener noreferrer">https://myaccount.google.com/security</a
		>
		und
	...
	<p>
		Die Datenverarbeitung, die mit der Google-Registrierung einhergeht beruht auf unserem
		berechtigten Interesse, unseren Nutzern einen m&ouml;glichst einfachen Registrierungsprozess zu
		erm&ouml;glichen (Art. 6 Abs. 1 lit. f DSGVO). Da die Nutzung der Registrierungsfunktion
		freiwillig ist und die Nutzer selbst &uuml;ber die jeweiligen Zugriffsm&ouml;glichkeiten
		entscheiden k&ouml;nnen, sind keine entgegenstehenden &uuml;berwiegenden Rechte der Betroffenen
		ersichtlich.
	</p>
	<p>
	...
	<p>
		...
		Systems AG, Quedlinburger Str. 1, 10589 Berlin, <a
			href="https://www.provenexpert.com"
			target="_blank"
			rel="noopener noreferrer">https://www.provenexpert.com</a
		>.
	</p>
	<p>
		Das ProvenExpert-Siegel erm&ouml;glicht es uns, Kundenbewertungen, die bei ProvenExpert zu
		unserem Unternehmen abgegeben wurden, auf unserer Website in einem Siegel darzustellen. Wenn Sie
		unsere Website besuchen, wird eine Verbindung mit ProvenExpert hergestellt, sodass ProvenExpert
		feststellen kann, dass Sie unsere Website besucht haben. Ferner erfasst ProvenExpert Ihre
		Spracheinstellungen, um das Siegel in der gew&auml;hlten Landessprache anzuzeigen.
	</p>
	<p>
		Die Verwendung von ProvenExpert erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der
		Websitebetreiber hat ein berechtigtes Interesse an einer m&ouml;glichst nachvollziehbaren
		Darstellung von Kundenbewertungen. Sofern eine entsprechende Einwilligung abgefragt wurde,
	...
	<p>
		...
		Werbeanzeigen eines Unternehmens (Advertiser) auf Webseiten von anderen Unternehmen des
		Affiliate-Partner-Netzwerks (Publisher) platziert. Wenn Sie auf eine dieser
		Affiliate-Werbeanzeigen klicken, werden Sie zum beworbenen Angebot weitergeleitet. Sollten Sie
		anschlie&szlig;end eine bestimmte Transaktion (Conversion) t&auml;tigen, erh&auml;lt der
		Publisher hierf&uuml;r eine Verg&uuml;tung. Zur Berechnung dieser Verg&uuml;tung ist es
		erforderlich, dass der Affiliate-Netzwerkbetreiber nachvollziehen kann, &uuml;ber welche
		Werbeanzeige Sie auf das jeweilige Angebot gekommen sind und die vordefinierte Transaktion
		vorgenommen haben. Hierf&uuml;r werden Cookies oder vergleichbare Wiedererkennungstechnologien
		(z.&nbsp;B. Device-Fingerprinting) eingesetzt.
	</p>
	<p>
		Die Speicherung und Analyse der Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der
		Websitebetreiber hat ein berechtigtes Interesse an der korrekten Berechnung seiner
		Affiliate-Verg&uuml;tung. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die
	...
	<p>
		Anbieter ist die Amazon Europe Core S.&agrave;.r.l. Details entnehmen Sie der
		Datenschutzerkl&auml;rung von Amazon unter: <a
	...
	<h4>AWIN</h4>
	<p>
		Betreiber des Affiliate-Netzwerks ist die AWIN AG, Eichhornstra&szlig;e 3, 10785 Berlin
		(nachfolgend &bdquo;AWIN&ldquo;).
	</p>
	<p>
		AWIN und der Publisher sind gemeinsam f&uuml;r die Datenverarbeitung im Zusammenhang mit dem
		Partnerprogramm verantwortlich. Die ihnen gemeinsam obliegenden Verpflichtungen wurden in einer
		Vereinbarung &uuml;ber gemeinsame Verarbeitung festgehalten. Laut dieser Vereinbarung
		k&ouml;nnen Sie sich mit Ihren datenschutzrechtlichen Anliegen an beide Verantwortlichen wenden.
		Der jeweils zuerst angesprochene Verantwortliche wird Ihre Anfrage beantworten. Jeder
		Verantwortliche h&auml;lt eigenst&auml;ndig Datenschutzinformationen nach Art. 13, 14 und 26
		DSGVO vor und trifft die erforderlichen Ma&szlig;nahmen zum Schutz personenbezogener Daten und
		zur Einhaltung der &uuml;brigen DSGVO-Vorschriften in seinem Unternehmen. Der Vertrag &uuml;ber
		gemeinsame Verarbeitung ist in den AGB von AWIN unter folgendem Link abrufbar: <a
			href="https://s3.amazonaws.com/docs.awin.com/Legal/Publisher+Terms/2020/DE+Publisher+Terms+GDPR+Annex.pdf"
			target="_blank"
			rel="noopener noreferrer"
			>https://s3.amazonaws.com/docs.awin.com/Legal/Publisher+Terms/2020/DE+Publisher+Terms+GDPR+Annex.pdf</a
		>.
	</p>
	...
	<p>
		...
		Begr&uuml;ndung, inhaltlichen Ausgestaltung und &Auml;nderung unserer Vertragsbeziehungen.
		Personenbezogene Daten &uuml;ber die Inanspruchnahme dieser Website (Nutzungsdaten) erheben,
		verarbeiten und nutzen wir nur, soweit dies erforderlich ist, um dem Nutzer die Inanspruchnahme
		des Dienstes zu erm&ouml;glichen oder abzurechnen. Rechtsgrundlage hierf&uuml;r ist Art. 6 Abs.
		1 lit. b DSGVO.
	</p>
	<p>
		Die erhobenen Kundendaten werden nach Abschluss des Auftrags oder Beendigung der
		Gesch&auml;ftsbeziehung und Ablauf der ggf. bestehenden gesetzlichen Aufbewahrungsfristen
		gel&ouml;scht. Gesetzliche Aufbewahrungsfristen bleiben unber&uuml;hrt.
	</p>
	<h3>
		Daten&shy;&uuml;bermittlung bei Vertragsschluss f&uuml;r Online-Shops, H&auml;ndler und
		Warenversand
	</h3>
	<p>
		Wenn Sie Waren bei uns bestellen, geben wir Ihre personenbezogenen Daten an das zur Lieferung
		betraute Transportunternehmen sowie an den mit der Zahlungsabwicklung beauftragten
		Zahlungsdienstleister weiter. Es werden nur solche Daten herausgegeben, die der jeweilige
		Dienstleister zur Erf&uuml;llung seiner Aufgabe ben&ouml;tigt. Rechtsgrundlage hierf&uuml;r ist
		Art. 6 Abs. 1 lit. b DSGVO, der die Verarbeitung von Daten zur Erf&uuml;llung eines Vertrags
		oder vorvertraglicher Ma&szlig;nahmen gestattet. Sofern Sie eine entsprechende Einwilligung nach
		Art. 6 Abs. 1 lit. a DSGVO erteilt haben, werden wir Ihre E-Mail-Adresse an das mit der
		Lieferung betraute Transportunternehmen &uuml;bergeben, damit dieses Sie per E-Mail &uuml;ber
		den Versandstatus Ihrer Bestellung informieren kann; Sie k&ouml;nnen die Einwilligung jederzeit
		widerrufen.
	</p>
	<h3>
		Daten&shy;&uuml;bermittlung bei Vertragsschluss f&uuml;r Dienstleistungen und digitale Inhalte
	</h3>
	<p>
		Wir &uuml;bermitteln personenbezogene Daten an Dritte nur dann, wenn dies im Rahmen der
		Vertragsabwicklung notwendig ist, etwa an das mit der Zahlungsabwicklung beauftragte
		Kreditinstitut.
	</p>
	<p>
		Eine weitergehende &Uuml;bermittlung der Daten erfolgt nicht bzw. nur dann, wenn Sie der
		&Uuml;bermittlung ausdr&uuml;cklich zugestimmt haben. Eine Weitergabe Ihrer Daten an Dritte ohne
		ausdr&uuml;ckliche Einwilligung, etwa zu Zwecken der Werbung, erfolgt nicht.
	</p>
	<p>
		Grundlage f&uuml;r die Datenverarbeitung ist Art. 6 Abs. 1 lit. b DSGVO, der die Verarbeitung
		von Daten zur Erf&uuml;llung eines Vertrags oder vorvertraglicher Ma&szlig;nahmen gestattet.
	</p>
	<h3>Zahlungsdienste</h3>
	<p>
		Wir binden Zahlungsdienste von Drittunternehmen auf unserer Website ein. Wenn Sie einen Kauf bei
		uns t&auml;tigen, werden Ihre Zahlungsdaten (z.&nbsp;B. Name, Zahlungssumme, Kontoverbindung,
		Kreditkartennummer) vom Zahlungsdienstleister zum Zwecke der Zahlungsabwicklung verarbeitet.
		F&uuml;r diese Transaktionen gelten die jeweiligen Vertrags- und Datenschutzbestimmungen der
		jeweiligen Anbieter. Der Einsatz der Zahlungsdienstleister erfolgt auf Grundlage von Art. 6 Abs.
		1 lit. b DSGVO (Vertragsabwicklung) sowie im Interesse eines m&ouml;glichst reibungslosen,
		komfortablen und sicheren Zahlungsvorgangs (Art. 6 Abs. 1 lit. f DSGVO). Soweit f&uuml;r
		bestimmte Handlungen Ihre Einwilligung abgefragt wird, ist Art. 6 Abs. 1 lit. a DSGVO
		Rechtsgrundlage der Datenverarbeitung; Einwilligungen sind jederzeit f&uuml;r die Zukunft
		widerrufbar.
	</p>
	<p>Folgende Zahlungsdienste / Zahlungsdienstleister setzen wir im Rahmen dieser Website ein:</p>
	<h4>PayPal</h4>
	<p>
		Anbieter dieses Zahlungsdienstes ist PayPal (Europe) S.&agrave;.r.l. et Cie, S.C.A., 22-24
		Boulevard Royal, L-2449 Luxembourg (im Folgenden &bdquo;PayPal&ldquo;).
	</p>
	<p>
	...
	<p>
		Details entnehmen Sie der Datenschutzerkl&auml;rung von PayPal: <a
	...
	<p>
		...
		Datenschutzerkl&auml;rung von Apple finden Sie unter: <a
			href="https://www.apple.com/legal/privacy/de-ww/"
			target="_blank"
			rel="noopener noreferrer">https://www.apple.com/legal/privacy/de-ww/</a
		>.
	</p>
	<h4>Google Pay</h4>
	<p>
		Anbieter ist Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Die
		Datenschutzerkl&auml;rung von Google finden Sie hier: <a
	...
	<h4>Stripe</h4>
	<p>
		Anbieter f&uuml;r Kunden innerhalb der EU ist die Stripe Payments Europe, Ltd.,1 Grand Canal
		Street Lower, Grand Canal Dock, Dublin, Irland (im Folgenden &bdquo;Stripe&ldquo;).
	</p>
	<p>
		Die Daten&uuml;bertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission
		gest&uuml;tzt. Details finden Sie hier: <a
	...
	<p>
		Details hierzu k&ouml;nnen Sie in der Datenschutzerkl&auml;rung von Stripe unter folgendem Link
		nachlesen: <a href="https://stripe.com/de/privacy" target="_blank" rel="noopener noreferrer"
			>https://stripe.com/de/privacy</a
		>.
	</p>
	<h4>Klarna</h4>
	<p>
		Anbieter ist die Klarna AB, Sveav&auml;gen 46, 111 34 Stockholm, Schweden (im Folgenden
		&bdquo;Klarna&ldquo;). Klarna bietet verschiedene Zahlungsoptionen an (z.&nbsp;B. Ratenkauf).
		Wenn Sie sich f&uuml;r die Bezahlung mit Klarna entscheiden (Klarna-Checkout-L&ouml;sung), wird
		Klarna verschiedene personenbezogene Daten von Ihnen erheben. Klarna nutzt Cookies, um die
		Verwendung der Klarna-Checkout-L&ouml;sung zu optimieren. Details zum Einsatz von Klarna-Cookies
		entnehmen Sie folgendem Link: <a
	...
	<p>
		Details hierzu k&ouml;nnen Sie in der Datenschutzerkl&auml;rung von Klarna unter folgendem Link
		nachlesen: <a
	...
	<h4>giropay</h4>
	<p>
		Anbieter dieses Zahlungsdienstes ist die paydirekt GmbH, Stephanstra&szlig;e 14 &ndash; 16,
		60313 Frankfurt am Main (im Folgenden &bdquo;giropay&ldquo;).
	</p>
	<p>
		Details entnehmen Sie der Datenschutzerkl&auml;rung von giropay: <a
	...
	<h4>Mastercard</h4>
	<p>
		Anbieter dieses Zahlungsdienstes ist die Mastercard Europe SA, Chauss&eacute;e de Tervuren 198A,
		B-1410 Waterloo, Belgien (im Folgenden &bdquo;Mastercard&ldquo;).
	</p>
	<p>
		Mastercard kann Daten an seine Muttergesellschaft in die USA &uuml;bermitteln. Die
		Daten&uuml;bertragung in die USA wird auf die Binding Corporate Rules von Mastercard
		gest&uuml;tzt. Details finden Sie hier: <a
	...
	<p>
		...
		Sheldon Square, London W2 6TT, Gro&szlig;britannien (im Folgenden &bdquo;VISA&ldquo;).
	</p>
	<p>
	...
	<p>
		VISA kann Daten an seine Muttergesellschaft in die USA &uuml;bertragen. Die
		Daten&uuml;bertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission
		gest&uuml;tzt. Details finden Sie hier: <a
	...
	<p>
		Weitere Informationen entnehmen Sie der Datenschutzerkl&auml;rung von VISA: <a
	...
	<ul>
		<li>
			<a
				...
				target="_blank"
				rel="noopener noreferrer">https://www.youtube.com/channel/UChpTG75PFHDO9NHlK8rV1og</a
			>
		</li>
	</ul>
